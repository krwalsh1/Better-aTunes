...
public class FolderTest {
	...
	public void testEquals() {
		f1 = new Folder("Folder 1");
		f2 = new Folder("Folder 2");
		
		Assert.assertFalse(f1.equals(af1));
	...
	public void testHashCode() {
		f1 = new Folder("Folder 1");
		f2 = null;
		f1.setParentFolder(f2);
		Assert.assertEquals(f1.hashCode(), f1.getName().hashCode());
		
		f1 = new Folder("Folder 1");
		f2 = new Folder("Folder 2");;
		f1.setParentFolder(f2);
		Assert.assertEquals(f1.hashCode(), (f1.getName() + f1.getParentFolder().getName()).hashCode());
